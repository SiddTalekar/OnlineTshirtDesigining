            ...
            <div class="container">
                <div class="content-spacing">
                    <div class="row">
                        ...
                        <asp:MultiView ID="MultiViewCheckout" ActiveViewIndex="2" runat="server">
                                ...
                                <div class="col-md-3 col-md-offset-1 col-sm-6">
                                    <div class="customized-form ">
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegValidEmail" runat="server" ErrorMessage="This email is missing the @ symbol" OnInit="RegValidEmail_Init" ControlToValidate="TextBoxUserEmail">
